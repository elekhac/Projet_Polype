...
#            if  hsv[i,j,0] < 0.5 and hsv[i,j,2]> 0.5:
#                laser[i,j] = 1
#    open_laser = laser
#    return open_laser
...
img = data.imread("images\\Polyps\\image2413.png")
...
skel_laser = morphology.skeletonize(open_laser > 0)
...
tranche2 = tranche(open_laser,50,30)
